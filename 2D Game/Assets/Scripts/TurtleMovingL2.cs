...
public class TurtleMovingL2 : MonoBehaviour
{
    public float speed;
    ...
    void Start()
    {
        startingPoint = new Vector3(transform.position.x, transform.position.y, 0f);
        endPoint = new Vector3(transform.position.x + 0.85f, transform.position.y, 0f);
        forwards = true;
